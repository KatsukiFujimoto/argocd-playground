...
```shell
$ kubectl apply -k ArgoCDがKustomize_デプロイするアプリケーションがKustomize/argocd/overlays/ -n argocd
application.argoproj.io/nginx created

$ kubectl get svc -n nginx
NAME    TYPE        CLUSTER-IP      EXTERNAL-IP   PORT(S)   AGE
nginx   ClusterIP   10.109.127.54   <none>        80/TCP    12s
...
< HTTP/1.1 200 OK
< Server: nginx/1.21.6
< Date: Tue, 22 Feb 2022 15:32:35 GMT
